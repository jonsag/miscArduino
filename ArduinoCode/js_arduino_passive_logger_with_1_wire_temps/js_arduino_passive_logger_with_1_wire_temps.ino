...
const int PROGMEM NTP_PACKET_SIZE= 48; // NTP time stamp is in the first 48 bytes of the message
...
void setup() {
  ...
  sensors.setResolution(temp1, 10); // set the resolution to 10 bit (good enough?)
      ...
      if (client.available()) {
        ...
        if (c == '\n') { //if HTTP request has ended
          ...
          if(readString.indexOf("readTemps") > 0) { //will read 1-wire temps
            ...
            tempValue1 = sensors.getTempC(temp1);
            tempValue2 = sensors.getTempC(temp2);
            Serial.print("Temp1: ");
